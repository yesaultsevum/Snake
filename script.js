...
(function ($) {
    ...
    function fillField() {
        var x, y;
        $('.main').html('');
        for (x = 0; x < size_field; x += 1) {
            for (y = 0; y < size_field; y += 1) {
    ...
    $(document).on('keydown', function (e) {
        if (e.keyCode === 37) { //left
            direction[0] !== 3 ? direction.push(1)
                : direction;
        } else if (e.keyCode === 38) { //up
            direction[0] !== 4 ? direction.push(2)
                : direction;
        } else if (e.keyCode === 39) { //right
            direction[0] !== 1 ? direction.push(3)
                : direction;
        } else if (e.keyCode === 40) { //down
            direction[0] !== 2 ? direction.push(4)
                : direction;
        }
    });
